...
export default function LineBarAreaChart(props) {
    ...
    function generateChartElements() {
        ...
        return __spreadArray(__spreadArray(__spreadArray([], areas, true), bars, true), lines, true);
    }
    return (React.createElement(ResponsiveContainer, { width: width ? width : defaultValues.width, height: height ? height : defaultValues.height },
        React.createElement(ComposedChart, { data: dataSource.data },
